...
def upgrade():
    ...
    op.create_index('idx_chat_sessions_is_deleted', 'chat_sessions', ['is_deleted'])
...
def downgrade():
    ...
    op.drop_index('idx_chat_messages_is_deleted', table_name='chat_messages')
    ...
    op.drop_index('idx_chat_sessions_is_deleted', table_name='chat_sessions')
